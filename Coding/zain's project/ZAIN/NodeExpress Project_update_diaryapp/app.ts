...
mongoose.connect('mongodb://localhost/Users');   //Mongodb Connection of database 'Users'.
...
app.get('/blog',function(req,res){
    res.render('blog',{name:req.body.name})
});
    ...
    model.find({"name":req.body.username},function(err,data:any){
      ...
      if(data[i].name==req.body.username && data[i].pw==req.body.pw){
          console.log(data[i].name);
            ...
            req.session.save();
            if(req.session["isLogin"]){ res.render('blog',{"name":req.body.username});}
