...
//Custom middleware
app.use('/home',function(req:express.Request,res:express.Response,next:Function)
{
	console.log('Middleware 1');
	next();
	
});
app.use('/about',function(req:express.Request,res:express.Response,next:Function){
